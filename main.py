...
def pipeline(frame):
    ...
    frame = preprocess.canny(frame,100,300)
...
if __name__ == "__main__":
    infile = "/Users/thabsheerhussain/Desktop/project/may19/yolov4_deepsort_lane_detection/test/AdvancedLaneDetection/data/dashcam_video_trim.mp4"
    outfile = "/Users/thabsheerhussain/Desktop/project/may19/yolov4_deepsort_lane_detection/test/AdvancedLaneDetection/data/dashcam_video_trim_mout.mp4"
    main(infile, outfile)